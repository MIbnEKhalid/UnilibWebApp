...
function createProductCard(product) {
    ...
    <div class="actions">
        ...
        <a href="/dashboard/Book/Edit/${product.id}" class="btn btn-edit" aria-label="Edit ${product.name}">
            <i class="fas fa-edit" aria-hidden="true"></i> Edit
        </a>
        <button class="btn btn-danger delete-btn" aria-label="Delete ${product.name}" data-id="${product.id}">
